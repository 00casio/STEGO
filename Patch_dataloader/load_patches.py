...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, help='Dataset Name', default="IXI")
    ...
    if args.dataset == "OASIXI":
        path_data = "/data/falcetta/datasets"
        original_data_dir = os.path.join(path_data, "preprocess_OASIXI/train")
